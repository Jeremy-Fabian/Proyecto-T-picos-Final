        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Formulario de la tipo de persona</h5>
        ...
        $('#btnNuevo').click(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $("#formModal #exampleModalLabel").html("Nuevo Tipo de Persona");
